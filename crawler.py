...
SITE_LINK = ""          #LINK TO LANDING PAGE OF SITE
...
TEL_NUM = " "            #EXPECTED TELEPHONE NUMBER, NO DASHES OR BRACKETS. BY DEFAULT IT SHOULD BE " "
EMAIL_ID = " "           #EXPECTED EMAIL. BY DEFAULT IT SHOULD BE " "
